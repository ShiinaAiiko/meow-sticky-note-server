...
func (bc *BaseControllers) NewConnect(e *nsocketio.EventInstance) error {
	...
	if err != nil || getUser == nil || getUser.Payload.Uid == 0 {
		...
		log.Info("SocketIO Client连接成功：", Conn.ID(), "/ UID", getUser.Payload.Uid)
...
func (bc *BaseControllers) Disconnect(e *nsocketio.EventInstance) error {
	c := e.ConnContext()
